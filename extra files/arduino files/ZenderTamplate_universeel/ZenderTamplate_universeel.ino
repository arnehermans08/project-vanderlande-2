...
void loop() {
  ...
  //                  |-dit vervangen-|
  sensoren[0].waarde = random(0, 100);  //vul de variabele in met de echt sensorwaardes(vervang de random waardes)
  sensoren[1].waarde = random(0, 100);
  sensoren[2].waarde = random(0, 100);
